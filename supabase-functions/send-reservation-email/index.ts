...
function buildEmailHtml(payload: any): string {
  const { reservation_code, created_at, student, grade, school_type, items } = payload;
  const schoolTypeLabel = school_type === "arabic" ? "مدرسة عربي (Arabic School)" : school_type === "languages" ? "مدرسة لغات (Languages School)" : "—";
  ...
  <div style="font-family: -apple-system, Segoe UI, Roboto, Arial, sans-serif; max-width:640px; margin:0 auto; color:#1f2937;">
    ...
    <div style="border:1px solid #e5e7eb;border-top:none;padding:24px 28px;border-radius:0 0 12px 12px;">
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px;margin-bottom:24px;">
        ...
        <tr><td style="padding:6px 0;color:#6b7280;">School Type</td><td style="padding:6px 0;font-weight:600;">${schoolTypeLabel}</td></tr>
